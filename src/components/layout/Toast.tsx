...
export default function Toast({ message }: ToastProps) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #0E7FA8 0%, #18A8D8 60%, #5CCBEE 100%)',
        boxShadow: '0 8px 32px rgba(24,168,216,.55), 0 2px 8px rgba(0,0,0,.12), inset 0 1px 0 rgba(255,255,255,.25)',
